<script setup>
import state from '../views/plp/plpState';
</script>
                ...
                <ul>
                    ...
                    <div>
                        <form>
                            ...
                            <label for="pr1"> Less than <i class="fa-solid fa-indian-rupee-sign icon-size"></i> 100</label><br><br>
                            <input type="checkbox" id="pr2" name="pr2" value="101-300" v-model="state.checkPriceRange">
                            <label for="pr2"> <i class="fa-solid fa-indian-rupee-sign icon-size"></i> 101 - <i class="fa-solid fa-indian-rupee-sign icon-size"></i> 300</label><br><br>
                            <input type="checkbox" id="pr3" name="pr3" value="301-500" v-model="state.checkPriceRange">
                            <label for="pr3"> <i class="fa-solid fa-indian-rupee-sign icon-size"></i> 301 - <i class="fa-solid fa-indian-rupee-sign icon-size"></i> 500</label><br><br>
                            <input type="checkbox" id="pr4" name="pr4" value="501-700" v-model="state.checkPriceRange">
                            <label for="pr4"> <i class="fa-solid fa-indian-rupee-sign icon-size"></i> 501 - <i class="fa-solid fa-indian-rupee-sign icon-size"></i> 700</label><br><br>
                            <input type="checkbox" id="pr5" name="pr5" value="701" v-model="state.checkPriceRange">
                            <label for="pr5"> Above <i class="fa-solid fa-indian-rupee-sign icon-size"></i> 701</label><br><br> 
                        </form>
                    </div>
                </ul>
            </nav>
